...
$info = [
    [
        'work_name' => 'Confectioner.',
        'work_date' => 'Aug 2017 - May 2020',
        'work_descrip' => 'I was making desserts .She made new combinations of tastes and developed technological maps.',

    ],
    [
        'work_name' => 'Tester',
        'work_date' => 'Sep 2020 - Dec 2021',
        'work_descrip' => 'I searched for bugs in games and compiled reports to correct errors.',
    ],
    [
        'work_name' => 'Web programmer',
        'work_date' => 'Jan 2022 - Current',
        'work_descrip' => 'Engaged in the creation of websites and business cards for different customers',
    ],
];
